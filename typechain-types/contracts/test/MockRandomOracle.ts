...
export interface MockRandomOracleInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "caller"
      | "fulfillRandomness"
...
export interface MockRandomOracle extends BaseContract {
  connect(runner?: ContractRunner | null): MockRandomOracle;
  waitForDeployment(): Promise<this>;

  interface: MockRandomOracleInterface;

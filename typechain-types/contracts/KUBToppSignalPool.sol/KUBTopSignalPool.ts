...
export interface KUBTopSignalPoolInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "EXACT_POOL_PORTION"
      | "FEE_POOL_PORTION"
  ...
  encodeFunctionData(
    functionFragment: "claimPrizesNext",
  ...
  encodeFunctionData(
    functionFragment: "sdkCallHelperRouter",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "sdkTransferRouter",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "settleNext", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "settledClosest",
    data: BytesLike
  ): Result;
...
export interface KUBTopSignalPool extends BaseContract {
  connect(runner?: ContractRunner | null): KUBTopSignalPool;
  waitForDeployment(): Promise<this>;

  interface: KUBTopSignalPoolInterface;
  ...
  claimPrizesNext: TypedContractMethod<
    [
      time: BigNumberish,
      price: BigNumberish,
      amount: BigNumberish,
  ...
  placeBidNext: TypedContractMethod<
    [
      time: BigNumberish,
      price: BigNumberish,
      amount: BigNumberish,
  ...
  sdkCallHelperRouter: TypedContractMethod<[], [string], "view">;

  sdkTransferRouter: TypedContractMethod<[], [string], "view">;

  settle: TypedContractMethod<[time: BigNumberish], [void], "nonpayable">;

  settleNext: TypedContractMethod<
    [time: BigNumberish, sender: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "claimPrizesNext"
  ): TypedContractMethod<
    [
      time: BigNumberish,
      price: BigNumberish,
  ...
  getFunction(
    nameOrSignature: "sdkCallHelperRouter"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
    nameOrSignature: "sdkTransferRouter"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
    nameOrSignature: "settle"
  ): TypedContractMethod<[time: BigNumberish], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "settleNext"
  ): TypedContractMethod<
    [time: BigNumberish, sender: AddressLike],
    [void],
    "nonpayable"

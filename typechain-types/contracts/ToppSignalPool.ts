...
export interface ToppSignalPoolInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "EXACT_POOL_PORTION"
      | "FEE_POOL_PORTION"
...
export interface ToppSignalPool extends BaseContract {
  connect(runner?: ContractRunner | null): ToppSignalPool;
  waitForDeployment(): Promise<this>;

  interface: ToppSignalPoolInterface;
